...
import { useEditTourContext } from 'views/AdminEditTour/Context';
import './styles.scss';
...
const Inner = memo(({ handleEditedTour, tourData, form }) => {
    useEffect(() => {
    ...
    const getAttractions = useCallback(() => {
        if (tourData?.attractions) {
            const attractionNames = tourData.attractions.map(
    ...
    const getDestinations = useCallback(() => {
        if (tourData?.destinations) {
            const destinationNames = tourData.destinations.map(
                ...
                <div className="add-new-tour">
                    <div className="add-new-tour__header">
                        ...
                        <p className="add-new-tour__header--intro">
                            Vui lòng chỉnh sửa các thông tin cần thiết để có thể
                            hoàn tất việc chỉnh sửa thông tin tour trên hệ thống
                            của bạn
                        </p>
                    </div>
                                ...
                                <div className="add-new-tour__content-inf1">
                                    ...
                                    <div className="add-new-tour__content-inf1--item">
                                        <Form.Item
                                            ...
                                            initialValue={tourData.max_customer}
                                        >
                                ...
                                <div className="add-new-tour__content-inf3">
                                    <div className="add-new-tour__content-inf3--item">
                                        <Form.Item
                                            ...
                                            initialValue={tourData.highlight}
                                        >
                                            <Input.TextArea
