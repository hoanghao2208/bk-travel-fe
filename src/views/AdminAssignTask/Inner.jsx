...
const Inner = memo(
    ({ form, tourguideData, tourData, handleAssignTask, setSelectedTour }) => {
        useEffect(() => {
                ...
                <div className="admin-assign-task">
                    <div className="admin-assign-task__header">
                        ...
                        <p className="admin-assign-task__header--intro">
                            ...
                            tất việc giao nhiệm vụ cho hướng dẫn viên của bạn.
                        </p>
                    </div>
