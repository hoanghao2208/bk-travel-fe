...
interface BellNotifyIconProps {
    hoverBell: boolean;
}

const BellNotifyIcon: FC<BellNotifyIconProps> = memo(({ hoverBell }) => {
    return (
        <svg
        ...
        >
            <path
                fill={hoverBell ? '#1890ff' : 'currentColor'}
...
BellNotifyIcon.displayName = 'BellNotifyIcon';

export default BellNotifyIcon;
